...
export default async function AppPlaylistsPage() {
  ...
  return <AppCatalog title="Playlists para ver" subtitle="Colecciones de videos para descubrir y mirar en familia." items={playlists} kind="playlist" getHref={(playlist) => `/app-home/playlists/${playlist.id}`} />
}
